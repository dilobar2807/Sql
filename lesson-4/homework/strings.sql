...
select isnull(FirstName, 'Unknown')+ ' ' +isnull(Email, 'noemail@example.com') as Email
...
select * from Employees
where salary > All (Select salary From Employee where DepartmentName='Sales');
